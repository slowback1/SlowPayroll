<?php
    ...
    if($result->num_rows > 0 ) {
        while($row = $result->fetch_assoc()) {
            if($row['hoursMoSt'] == null && $row['hoursMoEn'] == null && $row['hoursTuSt'] == null && $row['hoursTuEn'] == null && $row['hoursWeSt'] == null && $row['hoursWeEn'] == null && $row['hoursThSt'] == null && $row['hoursThEn'] == null && $row['hoursFrSt'] == null && $row['hoursFrEn'] == null && $row['hoursSaSt'] == null && $row['hoursSaEn'] == null && $row['hoursSuSt'] == null && $row['hoursSuEn'] == null) {
                $eid = $row['id'];
            ...
            if(get_total_hours($row['hoursMoSt'] , $row['hoursMoEn'] , $row['hoursTuSt'] , $row['hoursTuEn'] , $row['hoursWeSt'] , $row['hoursWeEn'] , $row['hoursThSt'] , $row['hoursThEn'] , $row['hoursFrSt'] , $row['hoursFrEn'] , $row['hoursSaSt'] , $row['hoursSaEn'] , $row['hoursSuSt'] , $row['hoursSuEn']) > 40 && $row['salary_type'] == 'hourly') {
                $eid = $row['id'];
                $name = $row['firstname'] . ' ' . $row['lastname'];
                $num_alerts += 1;
    ...
    if($num_alerts == 0) {
        echo "<div class='employerAlert'><p> You're all caught up on alerts!  Good job! </p></div>";
    }
